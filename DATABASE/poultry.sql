...
--
-- Host: localhost
-- Generation Time: Jun 27, 2024 at 02:04 AM
...
CREATE TABLE `chicken` (
  ...
  `chickenName` varchar(100) NOT NULL,
  `chickenType` varchar(20) NOT NULL,
...
INSERT INTO `chicken` (`chicken_id`, `chickenName`, `chickenType`, `dob`, `category`, `quantity`, `dates`) VALUES
(2, 'Pondezi', 'crolo', '2024-06-05', 'Inzungu', 10, '2024-06-27 00:00:14');
...
INSERT INTO `eggs` (`eggs_id`, `name`, `quantity`, `price`, `dates`) VALUES
(1, 'pondezi', 20, 200, '2024-06-26 21:46:54'),
(2, 'Inyarwanda', 5, 320, '2024-06-27 00:03:39');
...
(12, 'water', '32342', '2024-06-26 19:45:58');
...
--
ALTER TABLE `chicken`
  MODIFY `chicken_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `eggs`
--
ALTER TABLE `eggs`
  MODIFY `eggs_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
